...
import edu.hkust.clap.transformer.phase2.CLAPVisitor2;
import edu.hkust.clap.transformer.phase2.RecursiveVisitor2;
	...
	protected void internalTransform(String pn, Map map)
	{
		...
		while (classIt.hasNext()) 
		{
			...
			while (methodIt.hasNext()) 
			{
				...
				//Should handle threads created inside constructors
